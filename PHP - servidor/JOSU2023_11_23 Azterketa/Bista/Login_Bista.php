...
class Login_Bista {
    ...
    public function Login() {
        ?>
        <form method="POST" action="..\controllador\Controller.php">
            <div >
                <div >
    ...
    public function AukeraEmanOlen_DarOpcionesOlen($ebailtzaileak_usuarios){
        ...
        <form method="POST" action="..\controllador\Controller.php">
            <div>
                ...
                <br>
                <div>
                    <label><b>Opariak erregistratu:</b></label> 
                </div>
                <br>
                <input type="submit" value="Opariak Erregistratu" name="oparizek"/>
                <br>
            </div>
        </form>
        <?php
    ...
    public function EkintzakBistaratu_VisualizarAcciones ($ekintzak_acciones){
        ...
        ?>
        <form method="POST" action="..\controllador\Controller.php">
        <label><b> <?php $_SESSION['user'] ?> Erabiltzailearen ekintzak eguneratu:</b></label>
        <br><br>
    ...
    public function galdera_erantzunak_marraztu ($galdera_erantzunen_arraya){
        ...
        echo '<form method="POST" action="..\controllador\Controller.php.php">';
